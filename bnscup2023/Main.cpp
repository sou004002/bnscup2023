...
void Main()
{
	...
	////ごみの生成範囲
	//const int32 g_space = 30;
	//const int32 g_pos_x = gv.p_getter_x() + g_space;
	//const int32 g_pos_y = gv.p_getter_y() + g_space;
	//const int32 g_range_w = gv.w_getter() - g_space * 2;
	//const int32 g_range_h = gv.h_getter() - g_space * 2;
	...
	////マウスカーソル
	//const Image otete{ U"dotImages/foodFinger.svg" };
	//const Image ami{ U"dotImages/ami.svg" };
	//const Image allow{ U"dotImages/cursor.svg" };
